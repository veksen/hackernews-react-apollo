...
var Docker = /** @class */ (function () {
    ...
    Docker.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var port, endpoint, sliced, defaultVars, useHigherPort;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4: return [4 /*yield*/, this.setEnvVars(port, endpoint)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Docker.prototype.saveCluster = function () {
        var cluster = new prisma_yml_1.Cluster(this.clusterName, "http://" + this.hostName + ":" + this.envVars.PORT, this.privateKey);
                    ...
                    case 0:
                        ...
                        question = {
                            ...
                            choices: [
                                {
                                    value: 'stop',
                                    name: "Stop container running on " + constants_1.defaultPort,
                                },
                                {
                                    value: 'next',
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.run('logs', '-f')];
                }
            });
        });
    };
    Docker.prototype.nuke = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.cluster) return [3 /*break*/, 2];
                        endpoint = this.cluster.getDeployEndpoint();
                        sliced = endpoint.slice(endpoint.lastIndexOf(':') + 1);
                        port = sliced.slice(0, sliced.indexOf('/'));
                        ...
                        return [4 /*yield*/, this.run('down', '--remove-orphans', '-v', '--rmi', 'local')];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.setEnvVars(String(constants_1.defaultPort), "http://" + this.hostName + ":" + constants_1.defaultPort)];
                    case 3:
                        _a.sent();
    ...
    Docker.prototype.setEnvVars = function (port, endpoint) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Docker.prototype.stopContainersBlockingPort = function (port, nuke) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 9:
                        ...
                        this.out.log('');
                        return [3 /*break*/, 11];
                    case 10: throw new Error("Could not find container blocking port " + port + ". Please either stop it by hand or choose another port.");
    ...
    Docker.prototype.nukeContainers = function (name, isDB) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var argv, bin, defaultArgs, args, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        argv = ['down', '--remove-orphans', '-v', '--rmi', 'local'];
                        return [4 /*yield*/, this.getBin()];
                    case 1:
                        bin = _a.sent();
                        defaultArgs = [
                            '-p',
