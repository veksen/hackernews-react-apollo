...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projects, _loop_1, this_1, _i, _a, cluster, services, mappedServices;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _loop_1 = function (cluster) {
                            var clusterProjects, mappedClusterProjects, e_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this_1.client.initClusterClient(cluster, this_1.definition.getWorkspace() || '*', '*', '*')];
                                    case 1:
                                        _a.sent();
                                        _a.label = 2;
                                    case 2:
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [4 /*yield*/, this.client.getCloudServices()];
                    case 6:
                        services = _b.sent();
    ...
    List.prototype.printProjects = function (projects) {
