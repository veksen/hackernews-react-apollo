        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 11:
                        if (id === 'push') {
                            throw new Error("The " + chalk_1.default.bold('push') + " command has been replaced by the " + chalk_1.default.bold('deploy') + " command. Get more info with " + chalk_1.default.bold.green('prisma deploy --help'));
                        }
                        else if (id === 'local:down') {
                            throw new Error("The " + chalk_1.default.bold('local down') + " command has been replaced by the " + chalk_1.default.bold('local nuke') + " command. Get more info with " + chalk_1.default.bold.green('prisma local nuke --help'));
                        }
                        else {
