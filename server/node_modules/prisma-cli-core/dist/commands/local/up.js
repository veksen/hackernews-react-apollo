...
var Up = /** @class */ (function (_super) {
    ...
    Up.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var name, docker, cluster, before, showInit;
    ...
    Up.topic = 'local';
    Up.command = 'start';
    Up.description = 'Start local development cluster';
    Up.group = 'local';
    Up.flags = {
