...
var Client = (function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                ...
                                /*} else */ if (e_1.message.includes('ECONNREFUSED') &&
                                    ...
                                    localNotice = this.env.activeCluster.local
                                        ...
                                        : '';
                                    this.out.error("Could not connect to cluster " + chalk_1.default.bold(this.env.activeCluster.name) + ". " + localNotice);
                                }
                                else {
                                    throw e_1;
                                }
    ...
    Client.prototype.upload = function (serviceName, stage, exportData, token, workspaceSlug) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.env.activeCluster.getImportEndpoint(serviceName, stage, workspaceSlug), {
                            method: 'post',
                            headers: {
                                Authorization: "Bearer " + token,
                                'Content-Type': 'application/json',
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        authenticated = _a.apply(void 0, [_b.sent()]);
                        return [3 /*break*/, 3];
                    case 2:
                        e_2 = _b.sent();
                        return [3 /*break*/, 3];
    ...
    Client.prototype.login = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var secret, url, token, cloud;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requestCloudToken()];
                    case 1:
                        secret = _a.sent();
    ...
    Client.prototype.getCluster = function (name, stage) {
        return __awaiter(this, void 0, void 0, function () {
            var foundClusters, _i, _a, cluster, project, e_4, clusterNames;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        foundClusters = [];
