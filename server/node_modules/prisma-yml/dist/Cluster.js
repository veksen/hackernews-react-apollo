...
var Cluster = /** @class */ (function () {
    ...
    Cluster.prototype.getLocalToken = function () {
        if (!this.clusterSecret || this.clusterSecret === '') {
            throw new Error("Property '" + chalk_1.default.bold('clusterSecret') + "' of cluster " + chalk_1.default.bold(this.name) + " in ~/.prisma/config.yml is empty.\nPlease either provide a clusterSecret or run " + chalk_1.default.green.bold('prisma local start') + " to generate a new one. Read more here https://bit.ly/prisma-graphql-config-yml");
        }
        if (!this.cachedToken) {
