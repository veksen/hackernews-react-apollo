...
var Delete = /** @class */ (function (_super) {
    ...
    Delete.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var force, serviceName, workspaceName, stage, clusterName, cluster, prettyName, before;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.client.deleteProject(this.definition.getDeployName(), stage)];
                    case 5:
                        _a.sent();
