...
var Deploy = /** @class */ (function (_super) {
    ...
    Deploy.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var _a, force, watch, interactive, envFile, dryRun, serviceName, stage, cluster, isOnline, _b, gotCluster, value, envNotice, clusterWorkspace, workspace, projectNew;
                ...
                switch (_c.label) {
                    ...
                    case 6:
                        ...
                        if (!(this.definition.definition.cluster === 'local' &&
                            (!cluster || !isOnline))) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.localUp()];
                    case 7:
                        cluster = _c.sent();
                        return [3 /*break*/, 10];
                    case 8:
                        if (!(!isOnline && cluster && cluster.local)) return [3 /*break*/, 10];
                        return [4 /*yield*/, this.localUp()];
                    case 9:
                        cluster = _c.sent();
                        _c.label = 10;
                    ...
                    case 12:
                        ...
                        if (!(cluster && !cluster.local)) return [3 /*break*/, 14];
                        workspace = this.definition.getWorkspace();
                        if (!(workspace &&
                            !workspace.startsWith('public-') &&
                            (!this.env.globalRC.cloudSessionKey ||
                                this.env.globalRC.cloudSessionKey === ''))) return [3 /*break*/, 14];
                        return [4 /*yield*/, this.client.login()];
                    case 13:
                        _c.sent();
                        cluster.clusterSecret = this.env.globalRC.cloudSessionKey;
                        _c.label = 14;
                    case 14: return [4 /*yield*/, this.client.initClusterClient(cluster, this.definition.getWorkspace() || '*', serviceName, stage)];
                    case 15:
                        _c.sent();
                    ...
                    case 16:
                        _c.sent();
                        projectNew = false;
                        return [4 /*yield*/, this.projectExists(serviceName, stage, this.definition.getWorkspace())];
                    case 17:
                        if (!!(_c.sent())) return [3 /*break*/, 19];
                        return [4 /*yield*/, this.addProject(serviceName, stage, this.definition.getWorkspace())];
                    case 18:
                        _c.sent();
                        projectNew = true;
                        _c.label = 19;
                    case 19: return [4 /*yield*/, this.deploy(stage, serviceName, cluster, this.definition.definition.cluster, force, dryRun, projectNew, this.definition.getWorkspace())];
                    case 20:
                        _c.sent();
                        if (watch) {
    ...
    Deploy.prototype.localUp = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, up_1.default.run(new prisma_cli_engine_1.Config({ mock: false, argv: [] }))];
                    case 1:
                        _a.sent();
    ...
    Deploy.prototype.projectExists = function (name, stage, workspace) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = Boolean;
                        return [4 /*yield*/, this.client.getProject(util_1.concatName(name, workspace), stage)];
    ...
    Deploy.prototype.addProject = function (name, stage, workspace) {
        return __awaiter(this, void 0, void 0, function () {
            var createdProject;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.addProject(util_1.concatName(name, workspace), stage, this.definition.secrets)];
                    case 1:
    ...
    Deploy.prototype.deploy = function (stageName, serviceName, cluster, completeClusterName, force, dryRun, projectNew, workspace) {
        return __awaiter(this, void 0, void 0, function () {
            var localNote, before, b, verb, migrationResult, done, revision, migration;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.deploying = true;
                        ...
                        return [4 /*yield*/, this.client.deploy(util_1.concatName(serviceName, workspace), stageName, this.definition.typesString, dryRun, this.definition.getSubscriptions(), this.definition.secrets)];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.client.getMigration(util_1.concatName(serviceName, workspace), stageName)];
                    case 3:
                        migration = _a.sent();
                    ...
                    case 7:
                        ...
                        _a.label = 8;
                    case 8:
                        if (!migrationResult.migration) return [3 /*break*/, 13];
                        this.out.log(chalk_1.default.bold("\nHooks:\n"));
                        if (!(this.definition.definition.seed &&
                            !this.flags['no-seed'] &&
                            projectNew)) return [3 /*break*/, 10];
                        return [4 /*yield*/, this.seed(projectNew, serviceName, stageName, this.definition.getWorkspace())];
                    case 9:
                        _a.sent();
                        _a.label = 10;
                    case 10: return [4 /*yield*/, this.generateSchema(serviceName, stageName)];
                    case 11:
                        _a.sent();
    ...
    Deploy.prototype.seed = function (projectNew, serviceName, stageName, workspace) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, seeder.seed(util_1.concatName(serviceName, workspace), stageName)];
                    case 1:
                        _a.sent();
                        this.out.action.stop(util_1.prettyTime(Date.now() - before));
                        return [2 /*return*/];
    ...
    Deploy.prototype.generateSchema = function (serviceName, stageName) {
        return __awaiter(this, void 0, void 0, function () {
            var schemaPath, schemaDir, token, before, schemaString;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        schemaPath = this.definition.definition.schema || getSchemaPathFromConfig_1.getSchemaPathFromConfig();
                        ...
                        return [4 /*yield*/, printSchema_1.fetchAndPrintSchema(this.client, util_1.concatName(serviceName, this.definition.getWorkspace()), stageName, token)];
                    case 1:
    ...
    Deploy.prototype.graphqlPrepare = function () {
        return __awaiter(this, void 0, void 0, function () {
            var config, graphqlBin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        try {
                            config = graphql_config_1.getGraphQLConfig();
                        }
                        catch (e) {
                            //
                        }
                        if (!config) return [3 /*break*/, 3];
                        return [4 /*yield*/, getbin_1.getBinPath('graphql')];
                    case 1:
                        graphqlBin = _a.sent();
                        if (!graphqlBin) return [3 /*break*/, 3];
                        this.out.log("Running " + chalk_1.default.cyan("$ graphql prepare") + "...");
                        return [4 /*yield*/, spawn_1.spawn("graphql", ['prepare'])];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [2 /*return*/];
    ...
    Deploy.prototype.getCluster = function (serviceName, stage) {
        return __awaiter(this, void 0, void 0, function () {
            var loggedIn, workspaceClusterCombination, splitted, workspace, clusterName, exists;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        workspaceClusterCombination = _a.sent();
                    ...
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6: return [4 /*yield*/, this.definition.addCluster(workspaceClusterCombination, this.flags)];
                    case 7:
                        _a.sent();
                        return [2 /*return*/, {
    ...
    Deploy.prototype.getLocalClusterChoices = function () {
        var clusters = this.env.clusters.filter(function (c) { return c.local; }).map(function (c) { return c.name; });
        if (clusters.length === 0) {
            clusters.push('local');
        }
        return clusters.map(function (c) { return [c, 'Local cluster (requires Docker)']; });
    };
    Deploy.prototype.getLoggedInChoices = function () {
        return __awaiter(this, void 0, void 0, function () {
            var localChoices, workspaces, clusters, combinations, allCombinations;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        localChoices = this.getLocalClusterChoices();
                        return [4 /*yield*/, this.client.getWorkspaces()];
                    case 1:
                        workspaces = _a.sent();
                        clusters = this.env.clusters.filter(function (c) { return !c.local && c.name !== 'shared-public-demo'; });
                        combinations = [];
